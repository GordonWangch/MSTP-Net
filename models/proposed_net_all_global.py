...
class Intra_and_Inter_Block(nn.Module):
  def __init__(self, configs):
    super(Intra_and_Inter_Block, self).__init__()
...
class Mask_Generator(nn.Module):
  def __init__(self, configs):
    ...
    for _ in range(self.stack_num):
      self.dual_tas.append(Intra_and_Inter_Block(self.configs))
...
class MSTP_Model_all_global(nn.Module):
  def __init__(self, config):
    super(MSTP_Model_all_global,self).__init__()
    self.config = config
