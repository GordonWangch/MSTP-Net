...
class Dual_Tas_Model_nonalternation(nn.Module):
  def __init__(self, config):
    super(Dual_Tas_Model_nonalternation,self).__init__()
    self.config = config
...
if __name__ == "__main__":
  rnn = Dual_Tas_Model_nonalternation(256, 64, 128, bidirectional=True, norm='ln', num_layers=6)
  from torchinfo import summary
